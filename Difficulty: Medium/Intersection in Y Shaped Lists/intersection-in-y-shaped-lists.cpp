...
class Solution {
  public:
    ...
    while (ptr1 != ptr2) {
        // If either pointer reaches the end, reset it to the head of the other list
        ptr1 = (ptr1 ? ptr1->next : head2);
        ptr2 = (ptr2 ? ptr2->next : head1);
    }

    // At this point, ptr1 and ptr2 are either pointing to the intersection node or NULL
